...
Pi additionally supports sessions that T3 does not own, listed and controlled through the native-Pi
supervisor rather than the thread database. See
[native-pi-supervisor.md](../architecture/native-pi-supervisor.md).
